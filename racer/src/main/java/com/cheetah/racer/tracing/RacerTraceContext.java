 ...
 *
 * <p>
 * Format: {@code version "-" trace-id "-" parent-id "-" flags}
 * <ul>
...
public final class RacerTraceContext {
    ...
    /**
     * Generate a new root {@code traceparent} value with a fresh trace-id and
     * span-id.
     *
    ...
    public static String generate() {
        // ThreadLocalRandom is sufficient for correlation IDs — no cryptographic
        // guarantee needed, and avoids the SecureRandom lock at high concurrency.
     ...
     *
     * <p>
     * If {@code parent} is {@code null} or blank, a new root traceparent is
     * returned instead.
     *
    ...
    public static String extractTraceId(String traceparent) {
        ...
        if (traceId.length() != 32 || traceId.equals("00000000000000000000000000000000"))
            return null;
        return traceId;
    }
    ...
    public static String extractParentId(String traceparent) {
        ...
        if (parentId.length() != 16 || parentId.equals("0000000000000000"))
            return null;
        return parentId;
    }
