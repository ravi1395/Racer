 ...
 *
 * <p>
 * Wraps payload objects in a lightweight envelope:
 * 
 * <pre>
 * {
...
public class RacerChannelPublisherImpl implements RacerChannelPublisher {
        ...
        /**
         * When {@code true}, publishes via XADD to {@link #durableStreamKey} instead of
         * PUBLISH.
         */
        ...
        /**
         * Optional rate limiter (Phase 4.3). {@code null} when rate limiting is
         * disabled.
         */
        @Nullable
        ...
        public Mono<Long> publishAsync(Object payload, String sender, String messageId) {
                ...
                return rateLimitCheck
                                .then(validate)
                                .then(MessageEnvelopeBuilder.build(objectMapper, channelName, sender, payload, false,
                                                messageId))
                                .flatMap(json -> {
                                        if (durable) {
                                                MapRecord<String, String, String> record = MapRecord
