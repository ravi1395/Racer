 ...
 *
 * // Programmatic:
 * racerPriorityPublisher.publish("racer:orders", payload, "my-service", PriorityLevel.HIGH).subscribe();
 * </pre>
 *
...
public class RacerPriorityPublisher {
     ...
     *
     * <p>If {@code priorityLevel} is {@code null}, falls back to {@link PriorityLevel#NORMAL}.
     *
