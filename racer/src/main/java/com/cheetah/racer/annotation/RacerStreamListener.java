...
public @interface RacerStreamListener {
    ...
    /**
     * When {@code true}, enables idempotency deduplication for this stream listener.
     *
     ...
     * Duplicate messages are silently dropped (and ACKed) without invoking the handler.
     *
