...
class DlqReprocessorServiceTest {
        ...
        void setUp() {
                ...
                service = new DlqReprocessorService(dlqService, redisTemplate, objectMapper, NoOpRacerMetrics.INSTANCE);
        ...
        void republishOne_serializationFails_propagatesError() throws Exception {
                com.fasterxml.jackson.databind.ObjectMapper mockMapper = org.mockito.Mockito
                ...
                DlqReprocessorService failingService = new DlqReprocessorService(dlqService, redisTemplate, mockMapper,
