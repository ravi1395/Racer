...
class RacerCircuitBreakerRegistryTest {
    ...
    void setUp() {
        ...
        registry = new RacerCircuitBreakerRegistry(props, new NoOpRacerMetrics());
    }
    ...
    void getOrCreate_usesConfiguredWindowSize() {
        ...
        RacerCircuitBreakerRegistry r = new RacerCircuitBreakerRegistry(props, new NoOpRacerMetrics());
