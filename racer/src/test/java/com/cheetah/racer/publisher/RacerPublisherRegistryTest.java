...
class RacerPublisherRegistryTest {
    ...
    void channelWithBlankName_isSkippedDuringInit() {
        ...
        RacerPublisherRegistry reg = RacerPublisherRegistry.forTesting(props, redisTemplate, objectMapper);
        reg.init();
    ...
    @Test
    void fullConstructor_withEmptyMetrics_buildsRegistrySuccessfully() {
        RacerPublisherRegistry reg = RacerPublisherRegistry.forTesting(properties, redisTemplate, objectMapper);
        reg.init();
        assertThat(reg.getPublisher(null)).isNotNull();
    }
